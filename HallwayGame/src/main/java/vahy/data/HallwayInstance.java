...
public enum HallwayInstance {
    ...
    HallwayInstance(String path, int observationLenghtInCompactMode) {
        this.path = path;
        this.observationLenghtInCompactMode = observationLenghtInCompactMode;
    }
    ...
    public int getObservationLenghtInCompactMode() {
        return observationLenghtInCompactMode;
    }
}
