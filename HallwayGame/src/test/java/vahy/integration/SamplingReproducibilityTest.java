...
public class SamplingReproducibilityTest {
    ...
    @Test
    public void SamplingReproducibilityWithSingleEvalTest() {

        var algorithmConfig_0 = getAlgorithmConfig();
        var algorithmConfig_1 = getAlgorithmConfig();
        algorithmConfig_1.policyId("Base_2");
    ...
    @Test
    public void SamplingReproducibilityWithBatchedEvalTest() {

        var algorithmConfig_0 = getAlgorithmConfig();
        algorithmConfig_0.evaluatorType(EvaluatorType.RALF_BATCHED);
