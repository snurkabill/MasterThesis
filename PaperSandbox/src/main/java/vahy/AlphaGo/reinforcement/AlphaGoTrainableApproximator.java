...
public class AlphaGoTrainableApproximator implements Function<DoubleVectorialObservation, double[]> {

    private final SupervisedTrainableModel supervisedTrainableModel;

    public AlphaGoTrainableApproximator(SupervisedTrainableModel supervisedTrainableModel) {
