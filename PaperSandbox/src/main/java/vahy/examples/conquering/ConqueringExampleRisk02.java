...
public class ConqueringExampleRisk02 {
    ...
    public static void main(String[] args) throws IOException, InterruptedException, InvalidInstanceSetupException {
        var config = new BomberManConfig(1000, true, 100, 1, 4, 3, 3, 1, 2, 0.1, BomberManInstance.BM_02, PolicyShuffleStrategy.NO_SHUFFLE);
...
//        );
        ...
        var dataAggregator = new FirstVisitMonteCarloDataAggregator(new LinkedHashMap<>());
        var episodeDataMaker = new AlphaZeroDataMaker_V1<BomberManAction, BomberManRiskState>(policyId, totalActionCount, discountFactor, dataAggregator);
    ...
    private static PolicyDefinition<BomberManAction, DoubleVector, BomberManRiskState> getValuePolicy(SystemConfig systemConfig, int policyId, double discountFactor, int modelInputSize, int totalEntityCount, int totalActionCount) throws IOException, InterruptedException {
...
//        var predictorTrainingSetup2 = getRiskTrainingSetup(policyId, totalEntityCount, totalActionCount);
        ...
        var dataAggregator = new FirstVisitMonteCarloDataAggregator(new LinkedHashMap<>());
        var episodeDataMaker = new ValueDataMaker<BomberManAction, BomberManRiskState>(discountFactor, policyId, dataAggregator);
