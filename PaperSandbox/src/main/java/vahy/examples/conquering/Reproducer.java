...
public class Reproducer {
    ...
    private static List<Double> calculateResults(PolicyDefinition<BomberManAction, DoubleVector, BomberManRiskState> playerOne,
    ...
    public static void memoryLeakTest(Supplier<PolicyDefinition<BomberManAction, DoubleVector, BomberManRiskState>> playerOne,
...
//            }
    ...
    public static void main(String[] args) throws IOException, InvalidInstanceSetupException {
        ...
        memoryLeakTest(() ->  getRiskPolicy(config, 0), () -> getRiskPolicy(config, 1), config);
    }
