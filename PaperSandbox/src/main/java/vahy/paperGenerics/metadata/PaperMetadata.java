...
public class PaperMetadata<TAction extends Enum<TAction> & Action> extends AlphaZeroNodeMetadata<TAction> {
    ...
    public PaperMetadata(double[] cumulativeReward, double[] gainedReward, double priorProbability, double[] expectedRisk, EnumMap<TAction, Double> childPriorProbabilities) {
