...
public class PaperDataTablePredictorWithLr extends DataTablePredictor {

    private final int actionCount;
    private final double learningRate;
    private final int totalEntityCount;

    public PaperDataTablePredictorWithLr(double[] defaultPrediction, double learningRate, int actionCount, int totalEntityCount) {
