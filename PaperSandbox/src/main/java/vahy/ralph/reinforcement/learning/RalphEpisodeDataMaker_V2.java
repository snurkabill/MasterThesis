...
public class RalphEpisodeDataMaker_V2<TAction extends Enum<TAction> & Action, TState extends RiskState<TAction, DoubleVector, TState>> extends AbstractRalphEpisodeDataMaker<TAction, TState> {


    public RalphEpisodeDataMaker_V2(int playerPolicyId, int actionCount, double discountFactor, DataAggregator dataAggregator) {
        super(playerPolicyId, actionCount, discountFactor, dataAggregator);
    }

    public RalphEpisodeDataMaker_V2(int playerPolicyId, int actionCount, double discountFactor, int policyObservationLookbackSize, DataAggregator dataAggregator) {
