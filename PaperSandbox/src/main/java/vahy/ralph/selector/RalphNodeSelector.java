...
public class RalphNodeSelector<
    TAction extends Enum<TAction> & Action,
    TObservation extends Observation<TObservation>,
    TState extends State<TAction, TObservation, TState>>
    extends AbstractRiskAverseTreeBasedNodeSelector<TAction, TObservation, RalphMetadata<TAction>, TState> {

    protected final double cpuctParameter;
    protected final int[] indexArray;
    protected final double[] valueArray;

    public RalphNodeSelector(SplittableRandom random, boolean isModelKnown, double cpuctParameter, int totalActionCount) {
