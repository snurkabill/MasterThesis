...
risk_output   = tf.layers.dense(hidden_3, risk_output_count, tf.nn.sigmoid, use_bias = True, kernel_initializer = tf.zeros_initializer, bias_initializer = tf.zeros_initializer, name = "risk_output_node")
...
risk_loss = tf.keras.losses.mean_squared_error(y_true = risk_target, y_pred = risk_output)
