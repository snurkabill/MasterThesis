...
import vahy.ralph.policy.linearProgram.deprecated.MinimalRiskReachAbilityCalculatorDeprecated;
import vahy.ralph.policy.linearProgram.deprecated.OptimalFlowHardConstraintCalculatorDeprecated;
import vahy.ralph.policy.linearProgram.deprecated.OptimalFlowSoftConstraintDeprecated;
...
public class FlowConstraintCalculatorTest {
    ...
    public void optimalFlowHardConstraintComparisonTest() {
        ...
        var paperNodeSelector = new RalphNodeSelector<EmptySpaceAction, DoubleVector, EmptySpaceRiskState>(random.split(), true, 1.0, actionCount);

        var metadataFactory = new RiskSearchMetadataFactory<EmptySpaceAction, DoubleVector, EmptySpaceRiskState>(EmptySpaceAction.class, innerState.getTotalEntityCount());
        var nodeFactory = new SearchNodeBaseFactoryImpl<>(EmptySpaceAction.class, metadataFactory);
        var nodeEvaluator = new RalphNodeEvaluator<>(nodeFactory, new EmptyPredictor(new double[2 * 2 + actionCount]), true);
        ...
        for (int expandIterationCount = 1; expandIterationCount < TREE_UPDATE_COUNT; expandIterationCount++) {
            for (int j = 0; j < TREE_COUNT_PER_UPDATE; j++) {
                var state = new RiskStateWrapper<>(0, new EmptySpaceRiskState(new EmptySpaceState(random.nextBoolean(), random.nextBoolean()), random.split(),false, 0.05));
                ...
                var calculator = new OptimalFlowHardConstraintCalculator<EmptySpaceAction, DoubleVector, RalphMetadata<EmptySpaceAction>, EmptySpaceRiskState>(risk, null, noiseStrategy);
                sum_BUILD_CALC_1 += System.currentTimeMillis() - start;

                start = System.currentTimeMillis();
                var calculator2 = new OptimalFlowHardConstraintCalculatorDeprecated<EmptySpaceAction, DoubleVector, RalphMetadata<EmptySpaceAction>, EmptySpaceRiskState>(EmptySpaceAction.class, risk, null, noiseStrategy);
    ...
    public void optimalFlowSoftConstraintComparisonTest() {
        ...
        for (int k = 1; k < TREE_UPDATE_COUNT; k++) {
            for (int j = 0; j < TREE_COUNT_PER_UPDATE; j++) {
                ...
                long start = System.currentTimeMillis();
                var calculator = new OptimalFlowSoftConstraintCalculator<EmptySpaceAction, DoubleVector, RalphMetadata<EmptySpaceAction>, EmptySpaceRiskState>(risk, null, noiseStrategy);
                sum_BUILD_CALC_1 += System.currentTimeMillis() - start;

                start = System.currentTimeMillis();
                var calculator2 = new OptimalFlowSoftConstraintDeprecated<EmptySpaceAction, DoubleVector, RalphMetadata<EmptySpaceAction>, EmptySpaceRiskState>(EmptySpaceAction.class, risk, null, noiseStrategy);
                sum_BUILD_CALC_2 += System.currentTimeMillis() - start;
...
//                }
                ...
                long start = System.currentTimeMillis();
                var calculator = new MinimalRiskReachAbilityCalculator<EmptySpaceAction, DoubleVector, RalphMetadata<EmptySpaceAction>, EmptySpaceRiskState>();
                sum_BUILD_CALC_1 += System.currentTimeMillis() - start;
                ...
                start = System.currentTimeMillis();
                var calculator2 = new MinimalRiskReachAbilityCalculatorDeprecated<EmptySpaceAction, DoubleVector, RalphMetadata<EmptySpaceAction>, EmptySpaceRiskState>(EmptySpaceAction.class);
                sum_BUILD_CALC_2 += System.currentTimeMillis() - start;
    ...
    private static double[] fillArray(SearchNode<EmptySpaceAction, DoubleVector, RalphMetadata<EmptySpaceAction>, EmptySpaceRiskState> root, int actionCount) {
    ...
    private SearchTreeImpl<EmptySpaceAction, DoubleVector, RalphMetadata<EmptySpaceAction>, EmptySpaceRiskState> initializeTree(
        RalphNodeSelector<EmptySpaceAction, DoubleVector, EmptySpaceRiskState> ralphNodeSelector,
        RiskStateWrapper<EmptySpaceAction, DoubleVector, EmptySpaceRiskState> state,
        RalphNodeEvaluator<EmptySpaceAction, EmptySpaceRiskState> nodeEvaluator,
        SearchNodeFactory<EmptySpaceAction, DoubleVector, RalphMetadata<EmptySpaceAction>, EmptySpaceRiskState> searchNodeFactory,
        RiskSearchMetadataFactory<EmptySpaceAction, DoubleVector, EmptySpaceRiskState> searchNodeMetadataFactory
    )
    {
        var root = new SearchNodeImpl<EmptySpaceAction, DoubleVector, RalphMetadata<EmptySpaceAction>, EmptySpaceRiskState>(
            state,
        ...
        return new SearchTreeImpl<>(
            ...
            root,
            ralphNodeSelector,
            new RalphTreeUpdater<>(),
            nodeEvaluator
        );
    }

    private double buildTree(double sum_UCB, int expandIterationCount, SearchTreeImpl<EmptySpaceAction, DoubleVector, RalphMetadata<EmptySpaceAction>, EmptySpaceRiskState> searchTree) {
