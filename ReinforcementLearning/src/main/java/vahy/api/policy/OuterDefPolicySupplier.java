...
@FunctionalInterface
public interface OuterDefPolicySupplier<TAction extends Enum<TAction> & Action, TObservation extends Observation<TObservation>, TState extends State<TAction, TObservation, TState>> {
