...
public class VectorialStateHistoryObservationAggregator<TAction extends Action<TAction>> extends AbstractObservationAggregator<TAction, DoubleVector, DoubleVectorialObservationAggregation> {
