...
public class RiskEpisodeStatistics implements EpisodeStatistics {
    ...
    public RiskEpisodeStatistics(EpisodeStatisticsBase base, List<Long> riskHitCounter, List<Double> riskHitRatio, List<Double> riskHitStdev, List<Double> riskExhaustedIndexAverage, List<Double> riskExhaustedIndexStdev, List<Double> riskThresholdAtEndAverage, List<Double> riskThresholdAtEndStdev) {
        this.base = base;
