...
public class Example03 extends SHExperiment {
    ...
    protected List<PaperAlgorithmConfig> createAlgorithmConfigList() {
        return List.of(
            new AlgorithmConfigBuilder()
                ...
                // REINFORCEMENT
                .batchEpisodeCount(1000).stageCount(100).treeUpdateConditionFactory(new FixedUpdateCountTreeConditionFactory(50)).discountFactor(1)
