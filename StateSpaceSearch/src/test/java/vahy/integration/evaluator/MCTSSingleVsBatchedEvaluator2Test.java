...
public class MCTSSingleVsBatchedEvaluator2Test {
    ...
    private List<PolicyDefinition<BomberManAction, DoubleVector, BomberManState>> getPlayerSupplierList(int playerCount, int envEntitiesCount, int batchSize, ProblemConfig config, SystemConfig systemConfig, int modelInputSize) throws IOException, InterruptedException {
        ...
        var totalEntityCount = playerCount + envEntitiesCount;
...
//            var path_ = Paths.get("PythonScripts", "tensorflow_models", "value", "create_value_vectorized_model.py");
            ...
            var episodeDataMaker = new VectorValueDataMaker<BomberManAction, BomberManState>(discountFactor, playerId, dataAggregator);
            ...
            playerList.add(new MCTSPolicyDefinitionSupplier<BomberManAction, BomberManState>(BomberManAction.class, totalEntityCount, config).getPolicyDefinition(
                playerId,
                1,
                () -> 0.2,
                1,
    ...
    private List<List<Double>> runExperiment(BomberManConfig config, long seed, int batchSize) throws IOException, InterruptedException {
        ...
        var roundBuilder = RoundBuilder.getRoundBuilder("MCTSSingleVsBatchedTest2", config, systemConfig, algorithmConfig, policyList, BomberManInstanceInitializer::new);
    ...
    @Test
    public void singleVsBatchedEvaluator2Test() {
