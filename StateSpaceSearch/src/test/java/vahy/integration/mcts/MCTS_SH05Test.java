...
public class MCTS_SH05Test {
    ...
    public void convergence05Test(double trapProbability, double expectedMin, double expectedMax, int treeUpdateCount, long seed) {
        ...
        var roundBuilder = RoundBuilder.getRoundBuilder("MCTS_test_05", config, systemConfig, algorithmConfig, List.of(playerSupplier), SHInstanceSupplier::new);
